...
<title>
  ...
  <?php  echo $_W['page']['title'];?> - <?php  } ?>
  <?php  if(empty($_W['page']['copyright']['sitename'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>微赞 - 微信公众平台开源管理系统-012wz.com<?php  } ?><?php  } else { ?><?php  echo $_W['page']['copyright']['sitename'];?><?php  } ?></title>
  ...
  <div class="index" id="index">
    <div class="headbg">
      <div class="head" id="headbgg">
        <div class="mo" style=" left:-200px; padding-top:15px; position:absolute"></div>
        ...
        <div class="nav" id="nav">
          <ul >
            <li class="active" onClick="navmove('#index','0')"><a href="javascript:void(0);" title="网站首页">首页</a></li>
            ...
            <li onClick="navmove('#login','4')"><a href="<?php  echo url('user/login');?>" title="登陆">登陆</a></li>
            <li onClick="navmove('#login','4')"><a href="<?php  echo url('user/register');?>" title="注册">注册</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <ul >
    	<li>
    		<a href="<?php  echo url('user/login');?>">
    			<img src="./resource/weidongli/images/pic08.jpg" width="1920" height="612" alt="微信营销新时代">
    		</a>
    	</li>
    	<li>
    		<a>
    			<img src="./resource/weidongli/images/pic09.jpg" width="1920" height="612" alt="">
    		</a>
    	</li>
    	<li>
    		<a>
    			<img src="./resource/weidongli/images/pic10.jpg" width="1920" height="612" alt="微信营销新时代">
    		</a>
    	</li>
