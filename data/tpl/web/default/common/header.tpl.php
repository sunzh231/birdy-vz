	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<?php  } } ?>
				<?php  if(IMS_FAMILY != 'x') { ?>
				<li><a href="http://www.haoid.cn/post/451" target="_blank"><i class="fa fa-comment"></i>微赞论坛</a></li>
				<li><a href="https://mp.weixin.qq.com/" target="_blank"><i class="fa fa-comment"></i>微信公众平台</a></li>
				<li><a href="http://www.haoid.cn/post/451" target="_blank"><i class="fa fa-suitcase"></i>帮助</a></li>
				<?php  } ?>
			</ul>
			<?php  } else { ?>
			<ul class="nav navbar-nav">
