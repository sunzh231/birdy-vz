			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="alert alert-warning">
							<p>微赞9.0支持微信支付接口，注意你的微赞访问地址一定不要写错了，这里我们用访问地址代替下面说明中出现的链接，申请微信支付的接口说明如下：</p>
							<br>
							<h4>JS API网页支付参数</h4>
				...
				<div ng-show="wechat.switch == 'true'">
					...
					<div class="form-group s" id="apikey" <?php  if($pay['wechat']['version'] == 1) { ?> style="display:none;" <?php  } ?>>
						...
						<div class="col-sm-9 col-xs-12">
							...
							<span class="help-block">此值需要手动在腾讯商户后台API密钥保持一致，<a href="http://www.012wz.com/wiki/" target="_blank">查看设置教程</a></span>
						</div>
					</div>
				</div>
				<?php  } else { ?>
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<div class="alert alert-warning">
							你必须向微信公众平台提交企业信息以及银行账户资料，审核通过并签约后才能使用微信支付功能 <a href="http://www.012wz.com/wiki/" target="_blank">申请及详情请查看这里</a>.
						</div>
