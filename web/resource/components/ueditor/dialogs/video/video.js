...
(function(){
    ...
    function convert_url(url){
        ...
        url = utils.trim(url)
            ...
            .replace(/tudou\.com\/(listplay|albumplay)\/([\w\-=]+)\/([\w\-=]+)\.html/i, "www.tudou.com/programs/view/html5embed.action?type=0&code=$3&lcode=")
            .replace(/tudou\.com\/programs\/view\/([\w\-=]+)\//i, "www.tudou.com/programs/view/html5embed.action?type=0&code=$1&lcode=")
